    ...
    <div v-for="(book,n) in bookings" class="col-md-10">
      ...
      <md-ripple>
        ...
        <md-card-content>
          ...
          <div v-if = "book.event.booking_status == 'finished'">
            <md-radio v-model="reviews[n].rating" value="1">1</md-radio>
            <md-radio v-model="reviews[n].rating" value="2">2</md-radio>
            <md-radio v-model="reviews[n].rating" value="3">3</md-radio>
            <md-radio v-model="reviews[n].rating" value="4">4</md-radio>
            <md-radio v-model="reviews[n].rating" value="5">5</md-radio>
            <md-field>
